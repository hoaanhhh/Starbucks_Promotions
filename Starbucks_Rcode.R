...
### Leveraging Starbucks Promotional Data to 
### Enable Effective Customer Segmentation and Targeting
...
## data cleaning
### read file
profile <-read.csv("Starbucks-spending-prediction-main/data/profile.csv")
combined_data <- read.csv("Starbucks-spending-prediction-main/data/combined_data.csv")
portfolio <-read.csv("Starbucks-spending-prediction-main/data/portfolio.csv")
transcript <-read.csv("Starbucks-spending-prediction-main/data/transcript.csv")
